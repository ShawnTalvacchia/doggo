...
**Next phase to open: Pricing & Proposals.** Structurally enforce the no-bargaining principle. Provider pricing config (base + modifiers). Auto-pricing engine. ProposalForm refactored from "compose price" to "review system quote and confirm." See ROADMAP.md.
