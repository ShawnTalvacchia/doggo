...
## Current Phase: Between phases (Inbox & Notifications closed 2026-05-10)

Next phase TBD pending strategic review. Strong candidate: **Discover Refinement** (community-first ordering on /discover/care, Helper-tier surfacing, ProviderCard ↔ UserProfile bridging, service-aware filters, wired filter panel). Alt candidates with momentum: Demo Presentation, Onboarding & In-Product Communication. See ROADMAP.md.
...
**Upcoming:** Discover Refinement (likely next) → Cross-Cutting Flow Testing → Onboarding & In-Product Communication → Design System Cleanup → Demo Presentation. Reorganized 2026-05-04 around services-as-core. See ROADMAP.md.
