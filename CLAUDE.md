...
| `docs/strategy/Competitive Research - Adoption-Curious Journeys.md` | Shelter "explore before you commit" patterns; the **advocacy loop** (walkers surface dogs to OTHER adopters — the proven 5×/14× mechanism, not self-adoption); de-couple-walking-from-commitment, walk→photo/story capture, graceful off-ramps. Read before the Adoption-Curious Journey phase. |
