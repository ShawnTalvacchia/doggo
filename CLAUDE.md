...
| `docs/features/shelters.md` | Institutional accounts (`ShelterProfile` parallel to `UserProfile`), shelter page chrome (Feed/Dogs/Members/Gallery), the **operator back-office view** (shell, handover board, applications/stays/adoptions, walker pool), walker tier model, non-owned dog handling, anti-scoreboard discipline |
