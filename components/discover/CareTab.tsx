...
export function CareTab() {
  ...
  return (
    <>
      {/* Mobile sub-nav — only when a service is selected */}
      {filters.service && (
        <div className="explore-subnav">
          <button className="explore-subnav-back" onClick={() => updateFilters({ service: null as unknown as ServiceType })}>
      ...
      {/* Mobile service chooser — shown when no service selected */}
      {!filters.service && (
