...
export const mockPosts: Post[] = [
  ...
  /* ── Útulek Liběň feed ────────────────────────────────────────────────
   *
   * Walker-led: most of the feed comes from people who walk dogs at the
   * shelter and post about it, not from the shelter itself. The shelter's
   * own voice is reserved for things only the shelter can say (a new dog
   * arriving, a long-stayer who needs a special home, a call for more
   * walkers). This keeps the shelter from having to run a social media
   * account; walkers carry the surface naturally.
   *
   * Resolution: `getShelterFeed` picks up posts authored by the shelter
   * (`utulek-liben`) AND any post tagged with the shelter or one of its
   * dogs. See `lib/mockShelters.ts` and [[features/shelters]].
   * ────────────────────────────────────────────────────────────────── */

  /* ── Shelter-authored (3 posts) ──────────────────────────────────── */

  // Theo arrival celebration. New dog announcement; only the shelter can
  // post this. Walkers chime in via reactions and comments.
  {
  ...
  // Berta long-stayer call. The shelter knows her best and can write the
  // careful "this dog needs a special home" call. A walker would defer to
  // the shelter on this kind of post.
  {
  ...
  // Walker recruit. Recruitment lives with the shelter (operational ask),
  // not with individual walkers.
  {
   ...
   *
   * Each walker post tags the shelter AND the specific dog. Voices vary
   * by tier — the Trusted Handler (Pavel D.) takes the wary dogs, the
   * Experienced walkers (Marie, Lukáš, Helena) take the sociable ones,
  ...
  // Pavel (Trusted Handler) walks Šimon, the senior shepherd.
  {
  ...
  // Karolína (newest Vetted walker) takes Tonda. New-walker voice.
  {
    id: "post-walker-karolina-tonda",
  ...
  // Marie (Experienced) walks Maja. Smart-dog appreciation post.
  {
  ...
  // Anna (Vetted) walks Tonda. Quick atmospheric post.
  {
  ...
  // Lukáš (Experienced) takes Káťa, the shy dog with adoption pending.
  // Demonstrates the patience walkers bring to harder cases.
  {
    id: "post-walker-lukas-kata",
    ...
    tags: [
      { type: "shelter", id: "utulek-liben", label: "Útulek Liběň" },
      { type: "dog", id: "shelter-dog-kata", label: "Káťa" },
    ],
    createdAt: daysAgoIso(4, "15:20"),
    reactions: [
      { userId: "walker-pavel-d", userName: "Pavel D." },
      { userId: "walker-marie-b", userName: "Marie B." },
      { userId: "walker-helena-s", userName: "Helena S." },
    ...
    comments: [
      {
        id: "comment-walker-lukas-kata-1",
        authorId: "walker-pavel-d",
        authorName: "Pavel D.",
        authorAvatarUrl: "",
        text: "Quietly the best news I've read all week.",
        createdAt: daysAgoIso(4, "17:00"),
      },
    ],
  },

  // Pavel (Trusted Handler) walks Berta. Wary-dog handling. Important
  // post because it shows what the Trusted tier is actually for.
  {
    id: "post-walker-pavel-berta",
    authorId: "walker-pavel-d",
    authorName: "Pavel D.",
    authorAvatarUrl: "",
    ...
    createdAt: daysAgoIso(7, "13:00"),
    reactions: [
      { userId: "walker-marie-b", userName: "Marie B." },
      { userId: "walker-helena-s", userName: "Helena S." },
      { userId: "walker-lukas-p", userName: "Lukáš P." },
      { userId: "supporter-andrea-k", userName: "Andrea K." },
      { userId: "supporter-vojta-l", userName: "Vojtěch L." },
      { userId: "supporter-iveta-p", userName: "Iveta P." },
    ],
    comments: [
      {
        id: "comment-walker-pavel-berta-1",
        authorId: "walker-helena-s",
        authorName: "Helena S.",
        authorAvatarUrl: "",
        text: "Hero work, Pavel.",
        createdAt: daysAgoIso(7, "14:30"),
      },
    ],
  },

  // Helena (Experienced) walks Edda, the small terrier mix.
  {
    id: "post-walker-helena-edda",
    authorId: "walker-helena-s",
    authorName: "Helena S.",
    authorAvatarUrl: "",
    ...
    tags: [
      { type: "shelter", id: "utulek-liben", label: "Útulek Liběň" },
      { type: "dog", id: "shelter-dog-edda", label: "Edda" },
    ],
    createdAt: daysAgoIso(8, "12:00"),
    reactions: [
      { userId: "supporter-alena-t", userName: "Alena T." },
      { userId: "walker-anna-k", userName: "Anna K." },
    ],
  ...
  // Anna (Vetted) walks Líza. Sociable young dog with energy.
  {
    id: "post-walker-anna-liza",
    authorId: "walker-anna-k",
    authorName: "Anna K.",
    authorAvatarUrl: "",
    ...
    createdAt: daysAgoIso(10, "16:00"),
    reactions: [
      { userId: "walker-karolina-m", userName: "Karolína M." },
      { userId: "supporter-nela-d", userName: "Nela D." },
  ...
  // ─── Photos & Galleries phase (2026-06-04) — anchor-dog seed densification.
  // Each anchor persona dog needs 5–10 viewer-visible tagged posts so the
  // auto-album on /dogs/[id] reads populated. Pre-densification counts:
  // Bára 3, Hugo 2, Franta 4, Bella 1. Mix authors (owner, friends, walkers,
  // group members) so the resolver's viewer-gate is exercised by real
  // cross-persona views. Cross-pet tagging (Franta + Bella) demonstrates the
  // §12 cross-pet-households resolution — both dogs' albums pick up the same
  // post independently. Reuses existing image URLs to avoid asset churn.

  // ── Bella (Tereza's) ──────────────────────────────────────────────────────
  {
    id: "post-bella-zoomies",
    authorId: "tereza",
    authorName: "Tereza",
    authorAvatarUrl: "/images/generated/tereza-profile.jpeg",
    photos: ["/images/generated/post-dog-park-sunset.jpeg"],
    caption: "Bella's pre-dinner zoomies. The Border Collie cardio loop.",
    tags: [{ type: "dog", id: "bella", label: "Bella" }],
    createdAt: daysAgoIso(4, "18:30"),
    reactions: [
      { userId: "marek", userName: "Marek" },
      { userId: "eva", userName: "Eva" },
    ],
  ...
  {
    id: "post-franta-bella-nap",
    authorId: "tereza",
    authorName: "Tereza",
    authorAvatarUrl: "/images/generated/tereza-profile.jpeg",
    photos: ["/images/generated/post-sleepy-dogjpeg.jpeg"],
    caption: "The post-walk pile. Pretending they don't know each other in public, then this at home.",
    tags: [
      { type: "dog", id: "franta", label: "Franta" },
      { type: "dog", id: "bella", label: "Bella" },
    ],
    createdAt: daysAgoIso(8, "15:45"),
    reactions: [
      { userId: "shawn", userName: "Shawn" },
      { userId: "klara", userName: "Klára" },
      { userId: "marek", userName: "Marek" },
    ...
    comments: [
      {
        id: "comment-franta-bella-nap-1",
        authorId: "eva",
        authorName: "Eva",
        authorAvatarUrl: "/images/generated/eva-profile.jpeg",
        text: "Public dignity, private chaos. Love it.",
        createdAt: daysAgoIso(8, "16:20"),
      },
    ],
  },
  {
    id: "post-bella-herding",
    authorId: "marek",
    authorName: "Marek",
    authorAvatarUrl: "/images/generated/marek-profile.jpeg",
    groupId: "group-tereza-neighbourhood",
    groupName: "Vinohrady Evening Walkers",
    photos: ["/images/generated/evening-walk-group.jpeg"],
    caption: "Bella organised the entire group walk tonight. Toby kept trying to break formation; she was not having it.",
    tags: [
      { type: "dog", id: "bella", label: "Bella" },
      { type: "community", id: "group-tereza-neighbourhood", label: "Vinohrady Evening Walkers" },
    ],
    createdAt: daysAgoIso(12, "19:15"),
    reactions: [
      { userId: "tereza", userName: "Tereza" },
      { userId: "eva", userName: "Eva" },
      { userId: "hana", userName: "Hana" },
  ...
  {
    id: "post-bella-matching",
    authorId: "eva",
    authorName: "Eva",
    authorAvatarUrl: "/images/generated/eva-profile.jpeg",
    photos: ["/images/generated/post-matching-outfits.jpeg"],
    caption: "Bella and Goldie color-coordinated without anyone planning it. The universe approves.",
    tags: [
      { type: "dog", id: "bella", label: "Bella" },
      { type: "person", id: "tereza", label: "Tereza" },
    ],
    createdAt: daysAgoIso(18, "11:00"),
    reactions: [
      { userId: "tereza", userName: "Tereza" },
      { userId: "marek", userName: "Marek" },
    ],
  ...
  {
    id: "post-bella-training-focus",
    authorId: "tereza",
    authorName: "Tereza",
    authorAvatarUrl: "/images/generated/tereza-profile.jpeg",
    photos: ["/images/generated/post-training-recall.jpeg"],
    caption: "Bella locked in. She thinks recall practice is a job interview and she WILL get the job.",
    tags: [{ type: "dog", id: "bella", label: "Bella" }],
    createdAt: daysAgoIso(25, "10:00"),
    reactions: [
      { userId: "klara", userName: "Klára" },
      { userId: "marek", userName: "Marek" },
    ],
  ...
  {
    id: "post-bella-adoption-day",
    authorId: "tereza",
    authorName: "Tereza",
    authorAvatarUrl: "/images/generated/tereza-profile.jpeg",
    photos: ["/images/generated/bella-portrait.jpeg"],
    caption: "Four years with Bella today. The smartest, bossiest, most thoughtful dog I've ever known. Worth every chewed shoe in year one.",
    tags: [{ type: "dog", id: "bella", label: "Bella" }],
    createdAt: daysAgoIso(40, "08:30"),
    reactions: [
      { userId: "marek", userName: "Marek" },
      { userId: "eva", userName: "Eva" },
      { userId: "klara", userName: "Klára" },
  ...
  // ── Franta (Tereza's) — additions ─────────────────────────────────────────
  {
    id: "post-franta-puddle-mission",
    authorId: "tereza",
    authorName: "Tereza",
    authorAvatarUrl: "/images/generated/tereza-profile.jpeg",
    groupId: "group-tereza-neighbourhood",
    groupName: "Vinohrady Evening Walkers",
    photos: ["/images/generated/park-hangout-riegrovy.jpeg"],
    caption: "Franta's evening report: every puddle on the route, personally inspected.",
    tags: [
      { type: "dog", id: "franta", label: "Franta" },
      { type: "community", id: "group-tereza-neighbourhood", label: "Vinohrady Evening Walkers" },
    ],
    createdAt: daysAgoIso(6, "20:00"),
    reactions: [
      { userId: "marek", userName: "Marek" },
      { userId: "eva", userName: "Eva" },
    ],
  ...
  {
    id: "post-franta-hana-meet",
    authorId: "hana",
    authorName: "Hana",
    authorAvatarUrl: "/images/generated/hana-profile.jpeg",
    photos: ["/images/generated/meet-greeting.jpeg"],
    caption: "Franta did the gentleman bow to Bára this morning. Bára pretended not to notice. Cool girl behaviour.",
    tags: [
      { type: "dog", id: "franta", label: "Franta" },
      { type: "dog", id: "bara", label: "Bára" },
      { type: "place", id: "stromovka", label: "Stromovka" },
  ...
  // ── Bára (Daniel's) — additions ───────────────────────────────────────────
  {
    id: "post-bara-klara-progress",
    authorId: "klara",
    authorName: "Klára",
    authorAvatarUrl: "/images/generated/klara-profile.jpeg",
    groupId: "group-reactive-dogs",
    groupName: "Prague Reactive Dog Support",
    photos: ["/images/generated/post-reactive-walk.jpeg"],
    caption: "Bára and I worked on parallel walking with a calm helper dog today. She self-settled at 4m. Two months ago that distance was 15m. Owners — this is what progress looks like.",
    tags: [
      { type: "dog", id: "bara", label: "Bára" },
      { type: "person", id: "daniel", label: "Daniel" },
      { type: "community", id: "group-reactive-dogs", label: "Prague Reactive Dog Support" },
    ],
    ...
    comments: [
      {
        id: "comment-bara-klara-progress-1",
        authorId: "daniel",
        authorName: "Daniel",
        authorAvatarUrl: "/images/generated/daniel-profile.jpeg",
        text: "I cried reading this. Thank you for taking her on.",
        createdAt: daysAgoIso(5, "12:00"),
      },
    ],
  },
  {
    id: "post-bara-quiet-morning",
    authorId: "daniel",
    authorName: "Daniel",
    authorAvatarUrl: "/images/generated/daniel-profile.jpeg",
    photos: ["/images/generated/post-karlin-morning.jpeg"],
    caption: "Quiet Karlín morning. Just us and the river. These are the easy days I'm learning to appreciate.",
    tags: [
      { type: "dog", id: "bara", label: "Bára" },
      { type: "place", id: "karlin-riverfront", label: "Karlín riverfront" },
    ],
    createdAt: daysAgoIso(11, "07:15"),
    reactions: [
      { userId: "klara", userName: "Klára" },
      { userId: "hana", userName: "Hana" },
    ],
  ...
  {
    id: "post-bara-portrait-six-months",
    authorId: "daniel",
    authorName: "Daniel",
    authorAvatarUrl: "/images/generated/daniel-profile.jpeg",
    photos: ["/images/generated/bara-portrait.jpeg"],
    caption: "Six months with Bára. She still flinches at brooms. She also sleeps with her paw on my hand. We're figuring it out together.",
    tags: [{ type: "dog", id: "bara", label: "Bára" }],
    createdAt: daysAgoIso(30, "21:00"),
    reactions: [
      { userId: "klara", userName: "Klára" },
      { userId: "tereza", userName: "Tereza" },
      { userId: "hana", userName: "Hana" },
  ...
  // ── Hugo (Tomáš's) — additions ────────────────────────────────────────────
  {
    id: "post-hugo-wrecked",
    authorId: "tomas",
    authorName: "Tomáš",
    authorAvatarUrl: "/images/generated/tomas-profile.jpeg",
    photos: ["/images/generated/post-sleepy-dogjpeg.jpeg"],
    caption: "Petra walked Hugo this afternoon. This is the result. 10/10 service.",
    tags: [
      { type: "dog", id: "hugo", label: "Hugo" },
      { type: "person", id: "petra", label: "Petra" },
    ],
    createdAt: daysAgoIso(3, "19:00"),
    reactions: [
      { userId: "petra", userName: "Petra" },
      { userId: "klara", userName: "Klára" },
    ],
  ...
  {
    id: "post-hugo-petra-vitkov",
    authorId: "petra",
    authorName: "Petra",
    authorAvatarUrl: "/images/generated/petra-profile.jpeg",
    photos: ["/images/generated/post-sunset-vitkov.jpeg"],
    caption: "Hugo found a new favourite stick on the Vítkov loop today. He carried it the full way home.",
    tags: [
      { type: "dog", id: "hugo", label: "Hugo" },
      { type: "place", id: "vitkov", label: "Vítkov park" },
    ],
    createdAt: daysAgoIso(7, "17:45"),
    reactions: [
      { userId: "tomas", userName: "Tomáš" },
      { userId: "marek", userName: "Marek" },
    ],
  ...
  {
    id: "post-hugo-playdate",
    authorId: "eva",
    authorName: "Eva",
    authorAvatarUrl: "/images/generated/eva-profile.jpeg",
    photos: ["/images/generated/playdate-small-group.jpeg"],
    caption: "Hugo + Goldie + Toby — the lab pile. Tomáš, your dog is a menace (affectionate).",
    tags: [
      { type: "dog", id: "hugo", label: "Hugo" },
      { type: "person", id: "tomas", label: "Tomáš" },
    ],
    createdAt: daysAgoIso(15, "14:00"),
    reactions: [
      { userId: "tomas", userName: "Tomáš" },
      { userId: "petra", userName: "Petra" },
    ],
  ...
  {
    id: "post-hugo-petra-recall",
    authorId: "petra",
    authorName: "Petra",
    authorAvatarUrl: "/images/generated/petra-profile.jpeg",
    photos: ["/images/generated/post-training-recall.jpeg"],
    caption: "Recall work with Hugo at Stromovka. The food-motivated boys make the easiest students.",
    tags: [
      { type: "dog", id: "hugo", label: "Hugo" },
      { type: "place", id: "stromovka", label: "Stromovka" },
    ],
    createdAt: daysAgoIso(22, "10:30"),
    reactions: [
      { userId: "tomas", userName: "Tomáš" },
      { userId: "klara", userName: "Klára" },
    ],
  ...
  {
    id: "post-hugo-home-couch",
    authorId: "tomas",
    authorName: "Tomáš",
    authorAvatarUrl: "/images/generated/tomas-profile.jpeg",
    photos: ["/images/generated/hugo-portrait.jpeg"],
    caption: "Hugo's daily commute: bed → couch → bed. Vital infrastructure.",
    tags: [{ type: "dog", id: "hugo", label: "Hugo" }],
    createdAt: daysAgoIso(28, "21:30"),
    reactions: [
      { userId: "petra", userName: "Petra" },
      { userId: "eva", userName: "Eva" },
    ],
  ...
  {
    id: "post-hugo-anniversary",
    authorId: "tomas",
    authorName: "Tomáš",
    authorAvatarUrl: "/images/generated/tomas-profile.jpeg",
    photos: ["/images/generated/post-karlin-morning.jpeg"],
    caption: "Two years with Hugo. From the eight-week-old chaos goblin to (somehow) a real dog. The work pays off eventually.",
    tags: [
      { type: "dog", id: "hugo", label: "Hugo" },
      { type: "place", id: "karlin-riverfront", label: "Karlín riverfront" },
    ],
    createdAt: daysAgoIso(45, "08:00"),
    reactions: [
      { userId: "petra", userName: "Petra" },
      { userId: "klara", userName: "Klára" },
      { userId: "eva", userName: "Eva" },
