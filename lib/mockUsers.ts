  ...
  pets: [
    {
      ...
      personalityTags: ["affectionate", "good-with-dogs", "loves-walks"],
    ...
    },
    {
      ...
      personalityTags: ["smart", "wary-of-strangers", "good-with-dogs"],
  ...
  carerProfile: {
    ...
    services: [
      ...
      },
      {
        ...
        notes: "Behaviour-focused 1-on-1 for reactive and anxious dogs, at your address. Assessment included on the first session.",
      },
      {
        kind: "meet",
        id: "klara-reactive",
  ...
  pets: [
    {
      ...
      personalityTags: ["playful", "good-with-strangers", "good-with-dogs", "needs-basics"],
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Two trainers whose offerings exercise the appointment description +
