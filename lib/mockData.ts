...
export const providers: ProviderCard[] = [
  ...
  },
  {
    ...
    priceFrom: 550,
    priceUnit: "per_visit",
    blurb: "Mobile puppy trainer — visits your home, then a quiet park",
    avatarUrl: "/images/generated/anezka-profile.jpeg",
    // Appointment-only surfacing — like Lenka (groomer). Care `services`
    // stays empty; trainer offering routes through `appointmentTypes`.
    // P64, 2026-06-03.
    services: [],
    appointmentTypes: ["training"],
    availableTimes: ["6-11", "11-15"],
  ...
  },
  {
    ...
    priceFrom: 750,
    priceUnit: "per_visit",
    blurb: "Agility facility in Holešovice — owners bring their dog",
