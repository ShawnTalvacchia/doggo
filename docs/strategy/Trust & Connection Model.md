...
**Action is gated by meet-level engagement.** Familiar / Connect / Message pills render for viewers who have a seat in the meet — creators, anyone with any RSVP (past or future, going or interested), and anyone following the series. Random Discover viewers who haven't engaged with the meet see the same content but no action affordances. The card stack is identical across viewers; the action affordances differ.

The trust gradient is preserved: **the meet itself is the trust context.** What unlocks the ability to deepen is opting into the meet — RSVPing, following, hosting. What doesn't change is the information itself. Letting any viewer scope the room (who's coming, who you'd recognise, who you might want to meet) drives meet conversion without leaking anything the people in the room wouldn't show off.
