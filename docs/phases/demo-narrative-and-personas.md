...
- [ ] **W4.** Design spec for the interstitial + mode toggle + persona-switch transition lives in its chosen home doc, sufficient for a follow-on build phase to implement against
