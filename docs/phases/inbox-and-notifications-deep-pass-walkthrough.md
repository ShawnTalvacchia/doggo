...
- [ ] **A1. Klára → `/notifications` (`?as=klara`).** Page loads with the seeded notifications minus `notif-10`. No "Training session completed · Klára completed Bára's…" entry in the list.
