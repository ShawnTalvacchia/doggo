...
- [ ] **B5. Edit mode — Appointment card.** The *1-on-1 training session* card has: appointment name, price (Kč / appointment), Type pills (Training visit / Grooming — Training visit selected), appointment length, and notes. No linked-meets picker (appointments have no roster).
