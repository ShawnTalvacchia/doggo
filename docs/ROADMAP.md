...
**Service ↔ Meet Linkage** *(opens 2026-05-13)*. Authoring + linkage model for Care + Meet-type services in one place. Workstream A mid-flight; B unblocked by Profiles Deep Pass close. Phase board: `phases/service-meet-linkage.md`.
